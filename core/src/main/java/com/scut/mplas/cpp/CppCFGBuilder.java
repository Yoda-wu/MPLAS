...
public class CppCFGBuilder {
    ...
    private static class ControlFlowVisitor extends CppBaseVisitor<Void> {
         ...
         */
        @Override
        public Void visitAssignmentOperator(CppParser.AssignmentOperatorContext ctx) {
            return visitChildren(ctx);
        }

        @Override
        public Void visitExpression(CppParser.ExpressionContext ctx) {
         ...
         */
        @Override
        public Void visitConstantExpression(CppParser.ConstantExpressionContext ctx) {
            return visitChildren(ctx);
        }
         ...
         */
        @Override
        public Void visitStatement(CppParser.StatementContext ctx) {
            return visitChildren(ctx);
        }
         ...
         */
        @Override
        public Void visitLabeledStatement(CppParser.LabeledStatementContext ctx)
        //labeledStatement:
        ...
        @Override
        public Void visitExpressionStatement(CppParser.ExpressionStatementContext ctx)
        ...
        @Override
        public Void visitCompoundStatement(CppParser.CompoundStatementContext ctx) {
            return visitChildren(ctx);
        }
         ...
         */
        @Override
        public Void visitStatementSeq(CppParser.StatementSeqContext ctx) {
            return visitChildren(ctx);
        }
        ...
        @Override
        public Void visitCondition(CppParser.ConditionContext ctx) {
            return visitChildren(ctx);
        }
        ...
        //todo
        @Override
        public Void visitIterationStatement(CppParser.IterationStatementContext ctx)
        //iterationStatement:
...
//                        }
        ...
        @Override
        public Void visitBlockDeclaration(CppParser.BlockDeclarationContext ctx) {
         ...
         */
        @Override
        public Void visitAliasDeclaration(CppParser.AliasDeclarationContext ctx) {
            return visitChildren(ctx);
        }

        @Override
        public Void visitSimpleDeclaration(CppParser.SimpleDeclarationContext ctx) {
            //simpleDeclaration:
         ...
         */
        @Override
        public Void visitStaticAssertDeclaration(CppParser.StaticAssertDeclarationContext ctx) {
            return visitChildren(ctx);
        }
         ...
         */
        @Override
        public Void visitDeclSpecifier(CppParser.DeclSpecifierContext ctx) {
            return visitChildren(ctx);
        }

        @Override
        public Void visitDeclSpecifierSeq(CppParser.DeclSpecifierSeqContext ctx) {
         ...
         */
        @Override
        public Void visitStorageClassSpecifier(CppParser.StorageClassSpecifierContext ctx) {
            return visitChildren(ctx);
        }
         ...
         * {@inheritDoc}
             ...
             */
            @Override
            public Void visitOriginalNamespaceName(CppParser.OriginalNamespaceNameContext ctx) {
                return visitChildren(ctx);
            }

        @Override
        public Void visitNamespaceDefinition(CppParser.NamespaceDefinitionContext ctx) {
            //namespaceDefinition:
         ...
         */
        @Override
        public Void visitNamespaceAlias(CppParser.NamespaceAliasContext ctx) {
            return visitChildren(ctx);
        }
         ...
         *
             ...
             */
            @Override
            public Void visitParameterDeclaration(CppParser.ParameterDeclarationContext ctx) {
                return visitChildren(ctx);
            }

        @Override
        public Void visitFunctionDefinition(CppParser.FunctionDefinitionContext ctx) {
            //functionDefinition:
        ...
        @Override
        public Void visitFunctionBody(CppParser.FunctionBodyContext ctx) {
            return visitChildren(ctx);
        }
        //functionBody:
        ...
        @Override
        public Void visitInitializer(CppParser.InitializerContext ctx) {
            return visitChildren(ctx);
        }
         ...
         */
        @Override
        public Void visitBraceOrEqualInitializer(CppParser.BraceOrEqualInitializerContext ctx) {
            return visitChildren(ctx);
        }
         ...
         */
        @Override
        public Void visitClassHead(CppParser.ClassHeadContext ctx) {
            return visitChildren(ctx);
        }
         ...
         */
        @Override
        public Void visitClassHeadName(CppParser.ClassHeadNameContext ctx) {
            return visitChildren(ctx);
        }
        ...
        @Override
        public Void visitFunctionTryBlock(CppParser.FunctionTryBlockContext ctx) {
            //functionTryBlock:
         ...
         */
        @Override
        public Void visitHandlerSeq(CppParser.HandlerSeqContext ctx) {
            return visitChildren(ctx);
        }

        @Override
        public Void visitHandler(CppParser.HandlerContext ctx) {
            //handler:
         ...
         */
        @Override
        public Void visitExceptionDeclaration(CppParser.ExceptionDeclarationContext ctx) {
            return visitChildren(ctx);
        }
         ...
         */
        @Override
        public Void visitThrowExpression(CppParser.ThrowExpressionContext ctx)
         ...
         */
        @Override
        public Void visitLiteral(CppParser.LiteralContext ctx) {
            return visitChildren(ctx);
        }
