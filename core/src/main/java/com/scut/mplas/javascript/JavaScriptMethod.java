...
public class JavaScriptMethod {
    ...
    public JavaScriptMethod(String modifier, boolean isStatic, boolean isAbstract, String retType, String name, String[] argTypes, int line) {
        NAME = name;
        STATIC = isStatic;
        ABSTRACT = isAbstract;
        MODIFIER = modifier;
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof JavaScriptMethod))
            return false;
        JavaScriptMethod m = (JavaScriptMethod) obj;
