...
@Service
public class JavaScriptCodeAnalysisServiceImpl implements CodeAnalysisService {
    @Autowired
        ...
        try {
            ...
            while((line=reader.readLine())!=null)
            {
                ...
                String dataStr = new API(analysisArgsBuilder.
                        ...
                        setLanguageType(Execution.Languages.JAVASCRIPT).build()).getExec().ExecuteForAPI();
                result.add(dataStr);
            }
